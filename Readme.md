...
The chat is available in the sidebar of every editable content-object form. It receives the current form values, field schema, and field configuration, so it can answer questions about the object and propose changes to its fields.
